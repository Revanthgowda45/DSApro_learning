  ...
  useEffect(() => {
    if (isOpen && configured && messages.length === 0) {
      const welcomeMessage: ChatMessage = {
        id: 'welcome',
        role: 'model',
        content: `Hi! I'm your AI coding assistant. I'm here to help you with "${problem.title}". 
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex flex-wrap gap-2">
                ...
                >
                  ...
                  <span className="text-sm">Get Hints</span>
                </button>
                
                <button
                  onClick={analyzeApproach}
                  disabled={isLoading}
                  className="flex items-center space-x-2 px-3 py-2 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-200 dark:hover:bg-green-800 transition-colors disabled:opacity-50"
                >
                  <Code className="h-4 w-4" />
                  <span className="text-sm">Analyze Approach</span>
                </button>
                
                <button
                  onClick={getSimilarProblems}
                  disabled={isLoading}
                  className="flex items-center space-x-2 px-3 py-2 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors disabled:opacity-50"
                >
